  ...
  <div class="index">
    ...
    <div class="banner max-content">
      ...
      <div class="banner_href_box">
        <a href="https://aidesign.woa.com/aigc/#/workList" target="_blank" class="banner_href href1">一期作品查看>></a>
    ...
    <img class="banner_logo" src="../../assets/img/index/banner_logo2.png" alt=""/>
    ...
    <div class="introduce max-content" v-if="introduceData.length !== 0">
      ...
      <div class="introduce_text">本次大赛提供{{ introduceData.length }}个大赛命题，鼓励参赛者通过关键词、图象等方式进行AI绘图创意设计。</div>
    ...
    <div class="notice max-content">
      ...
      <div class="notice_item">
        ...
        <div class="notice_list">
          ...
          <div class="notice_list_text">3、作品需要使用AI Generated Content技术生成，例如Stable Diffusion、Midjourney、Dall-E 2、Kandinsky等</div>
          <div class="notice_list_text">4、作品需要包括图像、视频等内容物，以展示参赛者的创意和技术水平。</div>
          <div class="notice_list_text">5、作品需要提交作品说明以及AI创作过程文件，以便评审团了解作品的创意和技术细节。</div>
          <div class="notice_list_text">6、作品可以在ai生成图片/视频基础上进行二次加工优化，但必须同时提交原始生成效果素材和优化后的素材</div>
        </div>
        <div class="notice_list">
          <div class="notice_list_title">奖项</div>
          <div class="notice_list_text">本次大赛将依据“点赞数“评选出各类奖项</div>
          <ui>
        ...
        <div class="notice_list">
          ...
          <div class="notice_list_text">2.参赛作品，应以正向、积极的内容为导向，严禁包含但不限于低俗、色情、违反宗教活动的内容。</div>
          <div class="notice_list_text">3.参赛作品所涉及的著作权（包含但不限于知识产权、版权）不得侵犯第三人的合法权利。</div>
